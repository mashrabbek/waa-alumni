INSERT INTO tag (id, deleted, description, name) VALUES (1, false, 'Java developer position', 'ReactJS');
INSERT INTO tag (id, deleted, description, name) VALUES (2, false, 'Java developer position', 'Java');
...
--
-- INSERT INTO student (id, active, email, first_name, last_logged_in, last_name, password, address_id, gpa, major_id, deleted)
-- VALUES (1, true, 'Lead@gmail.com', 'John', null, 'Doe', 'Prsard1997', 1, 3.85, 1, false);
--
